...
namespace Netafim.WebPlatform.Web.Features.ProductCategory
{
    ...
    public class IocConfig : IConfigurableModule
    {
        ...
        {
            context.Services.AddTransient<IQueryComposer, ProductCategoryListingQueryComposer>();
            context.Services.AddTransient<IContentGenerator, ProductCategoryListingGenerator>();
        }
    }
}