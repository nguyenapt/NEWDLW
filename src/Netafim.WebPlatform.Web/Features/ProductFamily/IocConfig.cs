...
namespace Netafim.WebPlatform.Web.Features.ProductFamily
{
    ...
    public class IocConfig : IConfigurableModule
    {
        ...
        {
            context.Services.AddTransient<IProductFamilyRepository, ProductFamilyRepository>();
            context.Services.AddTransient<IQueryComposer, ProductFamilyListingQueryComposer>();
        }
    }
}