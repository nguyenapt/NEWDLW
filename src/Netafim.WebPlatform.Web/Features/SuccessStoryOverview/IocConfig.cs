...
namespace Netafim.WebPlatform.Web.Features.SuccessStoryOverview
{
    ...
    public class IocConfig : IConfigurableModule
    {
        ...
        {
            context.Services.AddTransient<IContentGenerator, SuccessStoryOverviewContentGenerator>();
            context.Services.AddTransient<ISuccessStoryFilterRepository, SuccessStoryFilterRepository>();
            context.Services.AddTransient<IQueryComposer, SuccessStoryFilterQueryComposer>();
        }
    }
}